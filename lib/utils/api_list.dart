class ApiList {
  static const baseUrl = "https://shop.startupsmile.in";
  //static const baseUrl = "https://demo.storeking.xyz";
   
  //static const licenseCode = "i9u99tt4-f0w6-71w7-8394-y968t02516r11";
  static const licenseCode = "123123";

  //static const mapApiKey = "AIzaSyCvcM-InOL7WIDVwDv3sGyxGJwPtAQ3Ei0";
  static const mapApiKey = "AIzaSyCPH348jfmgWvKsomwuKnUJHnIsY5Vyd_4"; //unimart map key we need to remove after testing
  ...
  static const showWishlist =
      "$baseUrl/api/frontend/product/wishlist-products?order_type=asc";
